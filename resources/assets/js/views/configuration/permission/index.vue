                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-10 col-lg-10 col-md-10">
                                <show-tip module="permission" tip="tip_permission"></show-tip>
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-8 col-md-8">
                                        <router-link to="/configuration/permission/assign" class="btn btn-sm btn-info pull-right">{{trans('permission.assign_permission')}}</router-link>
                                        <h4 class="card-title">{{trans('permission.permission_list')}}</h4>
                                        <h6 class="card-subtitle" v-if="permissions">{{trans('general.total_result_found',{'count' : permissions.total})}}</h6>
