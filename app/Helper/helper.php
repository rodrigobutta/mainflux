...
/*
 *  Used search in nested array
 *  @return string
 */
function nestedArraySearch($search_field, $search_value, $desired_field, $array)
{
    $index = array_search($search_value, array_column($array, $search_field));
    return ($index !== false) ? (isset($array[$index][$desired_field]) ? $array[$index][$desired_field] : null) : null;
}

/*
 *  Used to get company logo
 *  @return string
 */
