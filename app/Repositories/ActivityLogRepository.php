...
class ActivityLogRepository
{
     ...
     * @return void
     */
    public function __construct(ActivityLog $activity_log, UserRepository $user)
    {
    ...
    /**
     * Get activity log of all accessible users.
     *
     * @return ActivityLog
     */
    public function getAccessibleUserActivityLog()
    {
        return $this->activity_log->with('user', 'user.profile')->whereIn('user_id', $this->user->getAccessibleUserId())->orderBy('created_at', 'desc')->take(10)->get();
    }
